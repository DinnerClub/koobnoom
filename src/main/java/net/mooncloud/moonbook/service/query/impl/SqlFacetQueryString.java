package net.mooncloud.moonbook.service.query.impl;
...
public class SqlFacetQueryString
{
	...
	{
		// SELECT money,count,money/count AS mean FROM( SELECT SUM(money) AS
		// money, COUNT(1) AS count FROM user_payment_detail) T
		if (facet == true)
		{
